...
dn_lq_ak <- dn_lq_ak %>%
  mutate(distance = haversine(latitude.x, latitude.x, longitude.y, latitude.y, round=3))
...
***The minimum distance between a Denny's and La Quinta is 2.035***
...
***The average distance between a Denny's and La Quinta is 5649.286***
...
***There are 336 relationships between La Quinta and Denny's in NC, minimum distance is 9562.724, and the average is 9563.374***
...
dn_lq_tx_mindist <- dn_lq_tx %>%
  ...
  summarise(closest = min(distance))
```
***There are 47,400 relationships between La Quinta and Denny's in TX, minimum distance is 10910.26, and the average is 10893.11***
...
***There are 22,568 relationships between La Quinta and Denny's in CA, minimum distance is 11079.67, and the average is 11266.7***

12. Among the states you examined, where is Mitch Hedberg's joke most likely to hold true?
    Explain your reasoning.

***It holds true in North Carolina rather than California or Texas, because it has less distance between a Denny's and a Laquina.***
